...
func getChunkConf(c *cli.Context, format *meta.Format) *chunk.Config {
	...
	chunkConf := &chunk.Config{
		...
		RemoteCacheFailThreshold: c.Int("remote-cache-fail-threshold"),
		RemoteCacheNodeCooldown:  utils.Duration(c.String("remote-cache-node-cooldown")),
		RemoteCacheProbeInterval: utils.Duration(c.String("remote-cache-probe-interval")),
		RemoteCacheProbeTimeout:  utils.Duration(c.String("remote-cache-probe-timeout")),
